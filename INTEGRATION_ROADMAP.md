...
> Актуально на 2026-07-15. Это основной продуктовый и интеграционный план.
...
8. На стабильном desktop/profile фундаменте продолжить Android foundation (5A),
   после per-device модели подключить боевые сообщения Android (5B).
9. Затем довести MLS runtime, звонки и release polish.
